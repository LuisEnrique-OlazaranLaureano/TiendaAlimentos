...
<body id="container-page-index">
    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/prueba3.png" alt="slider1">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/prueba2.png" alt="slider2">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/prueba1.png" alt="slider3">
                <div class="carousel-caption">
    ...
    <section id="new-prod-index">    
         <div class="container">
            ...
            <div class="row">
              	<?php
                  include 'library/configServer.php'; //Incluir estos archivos
                  include 'library/consulSQL.php';//Incluir estos archivos
                  //condicion SQL para el stock de productos
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/food.jpg" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
