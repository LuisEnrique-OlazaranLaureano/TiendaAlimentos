    ...
    <section id="form-registration">
        <div class="container">
            ...
            <p class="lead text-center">
             Eres muy especial para nosotros, por lo cual es nuestro deber mantenerte al tanto de los mejores alimentos de mayor calidad para tu salud y a un precio totalmente económico.
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/reg.jpg" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
